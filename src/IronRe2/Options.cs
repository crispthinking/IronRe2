...
namespace IronRe2
{
    ...
    public class Options : UnmanagedResource<OptionsHandle>
    {
        ...
        public RegexEncoding Encoding
        {
            get
            {
                switch (Re2Ffi.cre2_opt_encoding(RawHandle))
                {
                    case Re2Ffi.cre2_encoding_t.CRE2_Latin1:
                        return RegexEncoding.Latin1;
                    case Re2Ffi.cre2_encoding_t.CRE2_UTF8:
                    case Re2Ffi.cre2_encoding_t.CRE2_UNKNOWN:
                    default:
                        return RegexEncoding.Utf8;
                }
            }
